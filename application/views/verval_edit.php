            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="<?= base_url('verval'); ?>" class="btn btn-sm btn-warning pull-right"><i
                                class="fa fa-arrow-left"></i> Kembali</a>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <?= form_open('verval/setujui_add'); ?>
                        <input type="hidden" name="kode_pengajuan" class="form-control"
                            value="<?= $data->kode_pengajuan; ?>" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="transport" class="form-control uang"
                                value="<?= $data->transport; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="">Transport Sopir</label>
                            <input type="text" name="sopir" class="form-control uang" value="<?= $data->sopir; ?>"
                                required>
                        </div>
                        <div class="form-group">
                            <label for="">Amplop</label>
                            <input type="text" name="nom_kriteria" class="form-control uang"
                                value="<?= $data->nom_kriteria; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for=""></label>
